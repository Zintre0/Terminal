		...
		<?php
			...
			switch ($_GET["num"]) {
				...
				case 5:
					...
					$sql1 = array ('TOTAL_PAGOS');
					$sql2 = 'SELECT SUM(MONTO_PAGO) AS TOTAL_PAGOS  FROM PAGO';
					tablas($sql1, $sql2, $enlace, 20);
				...
				case 7:
					...
					$sql1 = array ('TOTAL_PAGOS_SERVICIOS');
					$sql2 = 'SELECT SUM(COBRO_SERVICIO.PAGO_SERVICIO) AS TOTAL_PAGOS_SERVICIOS  FROM COBRO_SERVICIO';
					tablas($sql1, $sql2, $enlace, 20);
